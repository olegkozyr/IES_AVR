/*
* Програма 6. Робота з Ацп та 16-біт таймером.
*
* Призначення програми: виводить на дисплей значення АЦП
* в коді. 10-біт АЦП перетворює вхідну напругу в код
* від 0 до 1023.
*
* Обладнання:
...
int main06(void)
{
	...
	/* Нескінченний цикл періодичного АЦП перетворення напруги в код. */
	while (1)
	{
