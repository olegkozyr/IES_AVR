/* 
* Програма 4. Використання функцій.
* 
...
#define LED_0N            PORTB | (1<<PB5)   /* Увімкнути cвітлодіод. */
#define LED_OFF           PORTB & ~(1<<PB5)  /* Вимкнути світлодіод. */
#define PULLUP_ON         (1<<PB2)           /* Активація внутрішнього 
                                                підтягуючого резистора. */

#define SET_PORTB         LED_0N | PULLUP_ON /* Увімкнути cвітлодіод та активувати
...
int main4(void)
{
    ...
    while (1) 
    {
        ...
        {                                    /* Ні! */
            toggle_led(LED_0N);              /* Увімкнути cвітлодіод. */
        }
        else                                 /* Так! */
        {                                   
            toggle_led(LED_OFF);             /* Вимкнути світлодіод. */
        }
    }
    return 0;
}
