...
* Потрібна кількість тактів лічильника зберігається
* в регістрі OCR1A.
* Коли значення регістру TCNT1 стане рівним 
* значенню регістру OCF1A, в регістрі TIFR1
* встановлюється OCF1A біт, що викличе апаратне 
* переривання TIMER1_COMPA. Регістр лічильника
* TCNT1 обнулиться і флаг OCF1A очиститься автоматично.
* При цьому процесор * викличе функцію обробки 
* переривань ISR. Дана функція перемикає світлодіод.
*
