/*
* Програма 3. Використання переривань таймеру 1
* для оновлення LCD дисплея.
*
* Призначення програми: виводить послідовно всі
* чотиризначні числа на LCD дисплей.
*
* Обладнання:
...
#define CLEAR_TIMER        TCNT1 = 0x00                /* Очистка регістру поточного значення 
	                                                      лічильника. */
#define TIMER1_COMPA_COUNT OCR1A = 6250                /* Кількість тактів таймеру. */
